...
export default function ReviewsSection() {
  ...
  const sortedReviews = reviews
    ? [...reviews].sort((a, b) => Number(b.timestamp - a.timestamp))
    : [];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              ...
              experience with Newgate Coatings
            </p>
          </div>
            ...
            {isSubmitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">
                  Your review has been submitted and will be visible to other
                  customers.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="Patio Polyaspartic Coating">
                        Patio Polyaspartic Coating
                      </SelectItem>
                      <SelectItem value="Driveway Polyaspartic Coating">
                        Driveway Polyaspartic Coating
                      </SelectItem>
                      <SelectItem value="Pool Deck Polyaspartic Coating">
                        Pool Deck Polyaspartic Coating
                      </SelectItem>
                      <SelectItem value="Garage Floor Polyaspartic Coating">
