...
const services = [
  {
    ...
    description: 'Create stunning outdoor living spaces with weather-resistant polyaspartic coatings that withstand the elements while maintaining their beauty.',
  ...
  },
  {
    ...
    description: 'Transform pool areas with waterproof polyaspartic coatings designed for wet environments, providing safety and style.',
  ...
  },
  {
    ...
    description: 'Upgrade your garage with professional-grade polyaspartic flooring that resists stains, impacts, and heavy loads.',
...
export default function ServicesSection() {
  return (
    <section id="services" className="py-24 bg-concrete-light">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Professional polyaspartic coating solutions tailored to your specific needs
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-concrete-dark/80 to-transparent" />
              </div>
              <CardHeader>
                <CardTitle className="text-2xl text-copper">{service.title}</CardTitle>
