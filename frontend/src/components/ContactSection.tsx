...
export default function ContactSection() {
  ...
  const submitMutation = useMutation({
    mutationFn: async () => {
      ...
      await actor.submitQuoteRequest(id, formData.name, formData.email, combinedMessage);
    },
    onSuccess: () => {
      setIsSubmitted(true);
      setFormData({
  ...
  return (
    <section id="contact" className="py-24 bg-concrete-light">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Ready to transform your concrete surfaces? Contact us today for a free consultation and quote.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-muted-foreground">+1 (813) 608-2563</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-lg bg-copper/10 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <div className="text-muted-foreground">Newgatecoatings@icloud.com</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-lg bg-copper/10 flex items-center justify-center flex-shrink-0">
              ...
              <div className="bg-copper/10 rounded-lg p-6 border-l-4 border-copper">
                <h4 className="font-bold text-foreground mb-2">Why Request a Quote?</h4>
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="text-copper flex-shrink-0 mt-0.5" size={18} />
            ...
            <div className="bg-card rounded-lg p-8 shadow-lg border border-border">
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    {submitMutation.isPending ? 'Submitting...' : 'Request Free Quote'}
                  </Button>
